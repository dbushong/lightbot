...
(function() {
  var animate, animateTick, animating, animations, arrow, beige, body, body_height, body_radius, bodyg, bot, bulbBot, camera, canvas, clr, colorBot, def, defaults, flat_blue, flat_gray, game, gray, group, head, head_radius, headg, i, level_1_3, level_2_2, level_3_2, level_6_7, light, moveBotTo, moveLiftTo, pref, prev_coords, prop, renderer, rgb, rgbObj, row, scene, sky, speed, square, step, stp, toggleGoal, tops, tri, turnBotTo, updateScene, wireframe, x, y, _i, _j, _k, _len, _len1, _ref, _ref1;
