...
(function() {
  ...
  moveBotTo = function(x, y, jump) {
    ...
    return tween.onStart(function() {
      ...
      if (to_z !== from_z && jump) {
        return ([].splice.apply(coords.z, [1, 0].concat(_ref = Math.max(to_z, from_z) + 100)), _ref);
      }
    });
  };
