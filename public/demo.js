...
(function() {
  var animate, animateTick, animating, animations, arrow, beige, body, body_height, body_radius, bodyg, bot, botX, botY, botZ, bulbBot, camera, canvas, clr, colorBot, cur_level, def, def_level, defaults, flat_blue, flat_gray, floor, game, gameOver, gray, group, head, head_radius, headg, i, k, light, lvl, lvl_sel, moveBotTo, moveLiftTo, opt, pref, prev_coords, prop, renderer, rgb, rgbObj, row, scene, speed, square, step, stp, toggleGoal, tops, tri, turnBotTo, txt, updateScene, wireframe, x, y, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2, _ref3;
  ...
  cur_level = (_ref = localStorage.getItem('level')) != null ? _ref : def_level;

  game = Lightbot.Game.load((_ref1 = levels[cur_level]) != null ? _ref1 : levels[def_level]);
  ...
  moveBotTo = function(x, y, jump) {
    ...
    tween.onStart(function() {
      ...
      if (to_z !== from_z && jump) {
        return ([].splice.apply(coords.z, [1, 0].concat(_ref2 = Math.max(to_z, from_z) + 100)), _ref2);
      }
    });
    return tween;
  };
  ...
  document.body.addEventListener('mousedown', function(e) {
    var _ref4;
    if ((_ref4 = e.target) !== document.body && _ref4 !== renderer.domElement) {
      return;
    }
  ...
  document.body.addEventListener('mouseup', function(e) {
    var attr, _l, _len2, _ref4, _ref5, _results;
    if ((_ref4 = e.target) !== document.body && _ref4 !== renderer.domElement) {
      return;
    }
    prev_coords[e.button] = null;
    renderer.domElement.style.cursor = 'default';
    _ref5 = ['rotation', 'position', 'scale'];
    _results = [];
