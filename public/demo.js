...
(function() {
  var animate, animateTick, animating, arrow, beige, body, body_height, body_radius, bodyg, bot, bulbBot, camera, clr, coords, drag_start, flat_blue, flat_gray, game, gray, group, head, head_radius, headg, i, level_1_3, level_2_2, level_3_2, light, mask, moveBotTo, moveLiftTo, renderer, rgb, row, scene, square, start_rot, step, stp, toggleGoal, tops, tri, turnBotTo, updateScene, wireframe, x, y, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2, _ref3;
  ...
  mask = new THREE.Mesh(new THREE.PlaneGeometry(10000, 10000), new THREE.MeshBasicMaterial({
    color: 0
  }));
