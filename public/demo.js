...
(function() {
  var animate, animateTick, animating, arrow, beige, body, body_height, body_radius, bodyg, bot, bulbBot, camera, clr, def_cam_zpos, def_x_rot, flat_blue, flat_gray, game, gray, group, head, head_radius, headg, i, level_1_3, level_2_2, level_3_2, light, moveBotTo, moveLiftTo, prev_coords, renderer, rgb, row, scene, sky, square, step, stp, toggleGoal, tops, tri, turnBotTo, updateScene, wireframe, x, y, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4;
  ...
  camera.position.z = Number((_ref4 = localStorage.getItem('cam_zpos')) != null ? _ref4 : def_cam_zpos);
